...
export async function seed(knex: Knex): Promise<void> {
    ...
    await knex("QuestionAlternative").insert([
        ...
        {   idQuestionAlternative: 4, 
            ...
            explicationWhyResult: 'O cliente é responsável por ambas as tarefas, está incorreto. Isso não é verdade, a AWS realiza os backups.'
        },
        ...
        {   idQuestionAlternative: 4, 
            ...
            explicationWhyResult: 'INCORRECT: "Amazon DynamoDB" está incorreto. Este é um serviço sem servidor e você não precisa gerenciar patches.'
        },
        ...
        {   idQuestionAlternative: 5, 
            ...
            explicationWhyResult: 'INCORRECT: "Acesso root ao sistema operacional" está incorreto. Você não obtém acesso root ao sistema operacional de uma instância RDS.'
        },
        ...
        {   idQuestionAlternative: 4, 
            ...
            explicationWhyResult: 'INCORRECT: "Defina o valor DeleteOnTermination como falso para o volume raiz do EBS" está incorreto. Isso simplesmente preservará o volume da raiz; não irá realizar recuperação automática'
        },
        ...
        {   idQuestionAlternative: 4, 
            ...
            explicationWhyResult: 'INCORRECT: RDS permite que os usuários ajustem dinamicamente os recursos de CPU e RAM" está incorreto. Você não pode ajustar CPU e RAM dinamicamente, você deve alterar o tipo de instância e reinicializar a instância do banco de dados.'
        },
