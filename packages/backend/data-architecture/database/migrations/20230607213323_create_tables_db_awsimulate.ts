  ...
  return (
    knex.schema
      ...
      .createTable('Exam', function (table) {
        table.integer('id').notNullable();
        table.string('nameExam', 256).notNullable();
        table.string('descriptionExam', 1000).notNullable();
        table.string('versionExam', 45);
        table.time('timeDuration').notNullable();
        table.integer('quantityTotalQuestions').notNullable();
      ...
      .createTable('Question', function (table) {
        ...
        table
          .integer('QuestionSubject_id')
          .notNullable()
          .references('id')
          .inTable('QuestionSubject')
          .onDelete('CASCADE')
          .onUpdate('CASCADE');
        table
          .integer('QuestionType_id')
          .notNullable()
          .references('id')
          .inTable('QuestionType')
          .onDelete('CASCADE')
          .onUpdate('CASCADE');
      ...
      .createTable('PracticeExamHistoric', function (table) {
        ...
        table
          ...
          .onUpdate('CASCADE');
        table
          .integer('Simulation_id')
          .notNullable()
          .references('id')
          .inTable('SimulationExamQuestionAssociation')
          .onDelete('CASCADE')
          .onUpdate('CASCADE');
        table
          .integer('Exam_id')
      ...
      .createTable('QuestionAlternativeSelected', function (table) {
        table
          .integer('PracticeExamHistoric_id')
          .notNullable()
          .references('id')
          .inTable('PracticeExamHistoric')
          .onDelete('CASCADE')
          .onUpdate('CASCADE');
        table
          .integer('Person_id')
