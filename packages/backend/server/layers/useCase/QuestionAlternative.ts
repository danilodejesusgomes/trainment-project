...
export async function getQuestionAlternative(
  ...
  const questionAlternativeDb: QuestionAlternativeDb = await getQuestionAlternativeDb(idQuestionAlternative)
...
export async function listQuestionAlternativesByQuestionId(
  ...
  const questionAlternativeDb: QuestionAlternativeDb[] = await listQuestionAlternativeDbByQuestionId(idQuestion)
  
  const questionAlternative: QuestionAlternative[] = questionAlternativeDb.map((questionAlternativeDb) => {
    return convertQuestionAlternativeDbToQuestionAlternative(questionAlternativeDb);
  });
  
  return questionAlternative;
};

function convertQuestionAlternativeDbToQuestionAlternative(questionAlternativeDb: QuestionAlternativeDb): QuestionAlternative {
  return {
